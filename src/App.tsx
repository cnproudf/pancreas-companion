...
export default function App() {
  ...
  return (
    <SettingsProvider>
      <FoodLogProvider>
        {/*
          Outside AppShell, because it has consumers on BOTH sides of FlareGate:
          the sticky log bar above it and the Patterns tab inside it. One
          provider is what keeps an entry saved during a flare from going
          missing on the chart afterwards.
        */}
        <SymptomLogProvider>
          <AppShell>
            {/*
